...
return [
    ...
    'app_public_viewing' => 'Accepter l\'affichage public des ressources ?',
    ...
    'app_default_editor' => 'Éditeur de ressource par défaut',
    'app_default_editor_desc' => 'Sélectionnez l\'éditeur qui sera utilisé par défaut lors de l\'édition de nouvelles ressources. Cela peut être remplacé au niveau de la ressource où les permissions sont autorisées.',
    'app_custom_html' => 'HTML personnalisé dans l\'en-tête',
    'app_custom_html_desc' => 'Le contenu inséré ici sera ajouté en bas de la balise <head> de toutes les ressources. Vous pouvez l\'utiliser pour ajouter du CSS personnalisé ou un tracker analytique.',
    'app_custom_html_disabled_notice' => 'Le contenu de l\'en-tête HTML personnalisé est désactivé sur cette ressource de paramètres pour garantir que les modifications les plus récentes puissent être annulées.',
    ...
    'app_homeressource' => 'Ressource d\'accueil de l\'application',
    'app_homeressource_desc' => 'Choisissez une ressource à afficher sur la ressource d\'accueil au lieu de la vue par défaut. Les permissions sont ignorées pour les ressources sélectionnées.',
    'app_homeressource_select' => 'Choisissez une ressource',
    'app_footer_links' => 'Liens de pied de ressource',
    'app_footer_links_desc' => 'Ajoutez des liens dans le pied de ressource du site. Ils seront affichés en bas de la plupart des ressources, incluant celles qui ne nécesittent pas de connexion. Vous pouvez utiliser l\'étiquette "trans::<key>" pour utiliser les traductions définies par le système. Par exemple, utiliser "trans::common.privacy_policy" fournira la traduction de "Politique de Confidentalité" et "trans::common.terms_of_service" fournira la traduction de "Conditions d\'utilisation".',
    'app_footer_links_label' => 'Libellé du lien',
    'app_footer_links_url' => 'URL du lien',
    'app_footer_links_add' => 'Ajouter un lien en pied de ressource',
    'app_disable_comments' => 'Désactiver les commentaires',
    'app_disable_comments_toggle' => 'Désactiver les commentaires',
    'app_disable_comments_desc' => 'Désactive les commentaires sur toutes les ressources de l\'application. Les commentaires existants ne sont pas affichés.',
    ...
    'content_colors_desc' => 'Défini les couleurs pour tous les éléments de la hiérarchie d\'organisation des ressources. Choisir les couleurs avec une luminosité similaire aux couleurs par défaut est recommandé pour la lisibilité.',
    'bookshelf_color' => 'Couleur des domaines',
    'book_color' => 'Couleur des modules',
    'chapter_color' => 'Couleur des sous-modules',
    'ressource_color' => 'Couleur des ressources',
    'ressource_draft_color' => 'Couleur des brouillons',
    ...
    'sort_rule_op_chapters_first' => 'Sous-modules en premier',
    'sort_rule_op_chapters_last' => 'Sous-modules en dernier',

    // Maintenance settings
    'maint' => 'Maintenance',
    'maint_image_cleanup' => 'Nettoyer les images',
    'maint_image_cleanup_desc' => 'Scanne le contenu des ressources et des révisions pour vérifier les images, les dessins en cours d\'utilisation et les doublons. Assurez-vous d\'avoir une sauvegarde de la base de données et des images avant de lancer ceci.',
    'maint_delete_images_only_in_revisions' => 'Supprimer également les images qui n\'existent que dans les anciennes révisions de ressource',
    ...
    'maint_recycle_bin_desc' => 'Les domaines, modules, sous-modules et ressources supprimés sont envoyés dans la corbeille afin qu\'ils puissent être restaurés ou supprimés définitivement. Les éléments plus anciens de la corbeille peuvent être supprimés automatiquement après un certain temps selon la configuration du système.',
    ...
    'role_manage_entity_permissions' => 'Gérer les permissions sur les modules, sous-modules et ressources',
    'role_manage_own_entity_permissions' => 'Gérer les permissions de ses propres modules, sous-modules et ressources',
    'role_manage_ressource_templates' => 'Gérer les modèles de ressource',
    ...
    'role_editor_change' => 'Changer l\'éditeur de ressource',
    ...
    'role_asset_desc' => 'Ces permissions contrôlent l\'accès par défaut des ressources dans le système. Les permissions dans les modules, les sous-modules et les ressources ignoreront ces permissions',
    ...
    // Licensing
    'licenses' => 'Licences',
    'licenses_desc' => 'Cette ressource détaille les informations de licence pour BookStack ainsi que les projets et librairies utilisées dans BookStack. Nombre des projets listés peuvent n\'être utilisés que dans un contexte de développement.',
